---
name: paper-illustration-image2-codex
description: "Generate publication-quality academic illustrations through a local Codex app-server bridge that uses Codex native image generation. This is a separate experimental alternative to `paper-illustration-codex`, intended for Claude Code users who want a GPT-image-style renderer without modifying the original skill."
...
- **IMAGE2_HELPER** — canonical name `paper_illustration_image2.py`, resolved
  ...
  [ -f ".agents/skills/paper-illustration-image2-codex/scripts/paper_illustration_image2.py" ] && IMAGE2_HELPER=".agents/skills/paper-illustration-image2-codex/scripts/paper_illustration_image2.py"
  ...
  [ -z "$IMAGE2_HELPER" ] && [ -f ~/.codex/skills/paper-illustration-image2-codex/scripts/paper_illustration_image2.py ] && IMAGE2_HELPER="$HOME/.codex/skills/paper-illustration-image2-codex/scripts/paper_illustration_image2.py"
  [ -z "$IMAGE2_HELPER" ] && {
    ...
    echo "       /paper-illustration-image2-codex cannot proceed. Fix: rerun install_aris_codex.sh, export ARIS_REPO, or copy the canonical skill into ~/.codex/skills/." >&2
    exit 1
  }
  ```
...
**Not for:** Statistical plots (use `/paper-figure-codex`), deterministic vector topology figures (prefer `/figure-spec-codex`), photo-realistic scenes
