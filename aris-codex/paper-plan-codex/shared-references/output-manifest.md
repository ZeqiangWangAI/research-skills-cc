...
```
| 2025-06-15 14:30 | /idea-creator-codex | idea-stage/IDEA_REPORT_20250615_143022.md | idea-discovery | 12 ideas generated from "LLM reasoning" direction |
| 2025-06-15 14:30 | /idea-creator-codex | idea-stage/IDEA_REPORT.md | idea-discovery | latest copy |
```
...
| Stage | Skills |
|-------|--------|
| `idea-discovery-codex` | /idea-creator-codex, /idea-discovery-codex, /novelty-check-codex, /research-review-codex |
| `implementation` | /research-refine-codex, /research-refine-pipeline-codex, /experiment-plan-codex, /experiment-bridge-codex, /run-experiment-codex |
| `review` | /auto-review-loop-codex |
| `paper` | /paper-writing-codex, /paper-write-codex, /paper-compile-codex |
