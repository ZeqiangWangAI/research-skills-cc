---
name: patent-novelty-check-codex
...
Adapted from `/novelty-check-codex` for patent legal standards. Research novelty is NOT the same as patent novelty.
...
2. `patent/PRIOR_ART_REPORT.md` (output of `/prior-art-search-codex`)
