...
This skill runs **after** Workflow 3 (`/paper-writing-codex`). It takes a compiled paper and generates a presentation slide deck for conference oral talks, spotlight presentations, or poster lightning talks.
...
> 💡 Override: `/paper-slides-codex "paper/" — talk_type: oral, venue: ICML, minutes: 20, aspect: 4:3`
...
Same as `/paper-poster-html-codex`:
...
```
/paper-slides-codex "paper/" — talk_type: oral, venue: ICML, minutes: 20, aspect: 4:3, notes: false
```
