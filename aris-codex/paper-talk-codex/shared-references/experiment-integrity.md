...
The **reviewer model** (different family from executor) performs integrity checks via `/experiment-audit-codex`. The executor collects file paths; the reviewer reads code and results directly.
