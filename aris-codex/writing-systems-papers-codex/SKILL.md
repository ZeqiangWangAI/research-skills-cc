---
name: writing-systems-papers-codex
...
13. Hand off to /paper-write-codex for LaTeX generation and citation verification
```
...
- [ ] All citations verified (delegate to /paper-write-codex)
...
- Never generate citations from memory — use /paper-write-codex citation workflow
