...
→ Search for `[VERIFY]` markers left by `/paper-write-codex`. These indicate unverified citations or facts. Search for the correct information or flag to the user.
...
- [ ] Run `/paper-write-codex` to fix any content issues
