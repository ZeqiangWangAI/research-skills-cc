...
```text
Use $proof-orchestrator-codex to attempt this proof locally before preparing any GPT
Pro handoff.
...
```text
Use $proof-orchestrator-codex to continue this proof project locally from the prior
run.
...
```text
Use $proof-orchestrator-codex to prepare a manual GPT Pro handoff for the blocker in
...
```text
Use $proof-orchestrator-codex's optional DeepSeek audit branch for this run.
...
```text
Use $proof-orchestrator-codex to audit and edit the returned GPT Pro proof.
...
```text
Use $proof-orchestrator-codex to repair copy corruption in gpt-pro-output.md before
