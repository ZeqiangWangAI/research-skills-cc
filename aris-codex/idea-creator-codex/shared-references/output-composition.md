...
When a skill runs **inside an orchestrating pipeline** (e.g. `/idea-discovery-codex`,
`/research-pipeline-codex`, `/grant-proposal-codex`, `/kill-argument-codex`), its intermediate
