...
|-------|-----------------|-------|
| /idea-creator-codex | Full | IDEA_REPORT.md follows language setting |
| /idea-discovery-codex | Full | Inherits from sub-skills |
| /analyze-results-codex | Full | Result analysis follows language setting |
| /auto-review-loop-codex | Partial | AUTO_REVIEW.md follows setting; reviewer prompts stay English |
| /experiment-plan-codex | Full | EXPERIMENT_PLAN.md follows setting |
| /experiment-bridge-codex | Full | EXPERIMENT_RESULTS.md follows setting |
| /research-refine-codex | Full | FINAL_PROPOSAL.md follows setting |
| /research-refine-pipeline-codex | Full | PIPELINE_SUMMARY.md follows setting |
| /research-pipeline-codex | Full | Inherits from sub-skills |
| /result-to-claim-codex | Full | Claim descriptions follow setting |
| /paper-writing-codex | Skip | Always English LaTeX for submission |
| /paper-write-codex | Skip | Always English LaTeX |
