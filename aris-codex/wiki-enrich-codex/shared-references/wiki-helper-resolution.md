...
CC mirror at `wiki-helper-resolution.md`, adapted
for Codex's install layout (the helper may live under
`~/.codex/skills/research-wiki-codex/` for global installs).
...
## Variant A — hard-fail (for `/research-wiki-codex` itself)
...
- `../research-wiki-codex/SKILL.md` (Codex side) — uses Variant A
- CC-side mirror: `wiki-helper-resolution.md`
