...
Use this reference when `claims-drafting-codex`, `specification-writing-codex`, or `invention-structuring-codex` need guidance on patent-specific writing rules.
