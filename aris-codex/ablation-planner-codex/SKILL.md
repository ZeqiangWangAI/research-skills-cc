...
- Main results pass `/result-to-claim-codex` with `claim_supported = yes` or `partial`
- The user explicitly requests ablation planning
- `/auto-review-loop-codex` identifies missing ablations
...
- Confirmed and intended claims (from `/result-to-claim-codex` output or project notes)
