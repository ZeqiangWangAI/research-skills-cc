---
name: paper-poster-codex
description: "DEPRECATED — superseded by /paper-poster-html-codex. Kept only as a redirect for muscle memory; do not use for new posters."
argument-hint: "[paper-dir-or-pdf]"
allowed-tools: Read
---

# Paper Poster (DEPRECATED → /paper-poster-html-codex)
...
**Immediately proceed with `/paper-poster-html-codex`**, passing through all of the user's
