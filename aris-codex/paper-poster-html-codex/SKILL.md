...
- **SKILL_SCRIPTS** — helpers and templates are single-owner and ship inside the
  ...
  ```bash
  SKILL_HOME=""
  [ -d ".agents/skills/paper-poster-html-codex/scripts" ] && SKILL_HOME=".agents/skills/paper-poster-html-codex"
  ...
  [ -z "$SKILL_HOME" ] && [ -d "$HOME/.codex/skills/paper-poster-html-codex/scripts" ] && SKILL_HOME="$HOME/.codex/skills/paper-poster-html-codex"
...
- Slides, not a poster → `/paper-talk-codex` / `/slides-polish-codex`.
