...
2. If ablation studies are incomplete → trigger `/ablation-planner-codex`
...
if research-wiki/ exists:
    ...
    #    sound-modulo-imports / drafted / retracted), owned by /proof-checker-codex (the claim
    ...
    Count failed/partial ideas since last /idea-creator-codex run.
    If >= 3: print "💡 3+ ideas tested since last ideation. Consider re-running /idea-creator-codex — the wiki now knows what doesn't work."
```
