...
- reasoning effort: **two tiers** (since 2026-07-10; `ultra`/`max` need codex-cli ≥ 0.144.1) —
  **deep-audit** skills use `ultra` (`proof-checker-codex`, `kill-argument-codex` core threads, `research-review-codex`,
  `experiment-audit-codex`, `paper-claim-audit-codex`, `result-to-claim-codex`, `meta-apply-codex`); **every other**
...
`/auto-review-loop-codex` to Copilot CLI's native complementary `rubber-duck`
...
- `auto-review-loop-codex`
- `experiment-audit-codex`
- `proof-checker-codex`
- `rebuttal`
- `idea-creator-codex`
- `research-lit-codex`
