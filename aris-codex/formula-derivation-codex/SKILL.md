...
## Relationship to `proof-writer-codex`

Use `formula-derivation-codex` when the user says things like:
- “我不知道怎么起这条推导主线”
- “这个公式到底该从哪个量出发”
- “帮我把理论搭顺”
- “把说明文档变成可写进论文的公式文档”
...
Use `proof-writer-codex` only after:
